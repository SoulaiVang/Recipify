    ...
    <>
        ...
        <div className='landing-page-container'>
            <div className="text-content">
                ...
                <p className='website-intro'>Have you ever had a bunch of ingredients within your pantry but never know what to cook with it? Well look no further! Recipfy looks to streamline this process by providing an 'ingredient search engine' to help you find your next tasty meal to cook!</p>
